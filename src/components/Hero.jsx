  ...
  return (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradiemt rounded-[10px] mb-2'>
      ...
      <div className={`flex-1 flex max-ss:flex-col ${styles.flexCenter} md:my-0 my-10 relative`}>
